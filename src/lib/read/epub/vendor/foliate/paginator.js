...
export class Paginator extends HTMLElement {
    ...
    async goTo(target) {
        // PATCH (see VENDORED.md): wait out the navigation lock instead of
        // silently dropping the call — a goTo issued during a page-turn
        // animation (e.g. a TOC click right after paginating) must still land.
        for (let i = 0; this.#locked && i < 150; i++) await wait(20)
