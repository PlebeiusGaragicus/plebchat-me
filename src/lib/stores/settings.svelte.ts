...
//
// Storage key is 'plebchat-settings' — must never collide with the frozen
// vibereader app's 'vibereader-settings' on the shared plebchat.me origin.

import { RELAYS } from '$lib/relays.js';

const STORAGE_KEY = 'plebchat-settings';
...
/** Reader display settings — applied inside the book iframe, synced as 30103. */
